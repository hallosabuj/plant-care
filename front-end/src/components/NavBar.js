                                ...
                                <div className="flex space-x-4">
                                    {this.state.navigation.map((item) => (
                                        <NavLink
                                            key={item.name}
                                            to={item.href}
                                            className={this.state.currentPage===item.href ? 'bg-gray-700 text-white px-3 py-1 rounded-t-[5%] rounded-b-[5%] rounded-l-[20%] rounded-r-[20%]' : 'text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-1 rounded-t-[5%] rounded-b-[5%] rounded-l-[20%] rounded-r-[20%] text-sm font-medium'}
