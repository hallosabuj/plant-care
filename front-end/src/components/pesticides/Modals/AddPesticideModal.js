...
class AddPesticideModal extends Component {
  ...
  closeForm = (event) =>{
    if (event.target.id === "addPesticideForm") {
      this.toggleShowModal()
    }
  }
  form() {
  ...
  render() {
    ...
    return (
      <>
        ...
        {showModal ? (
          <>
            <div onClick={this.closeForm} id='addPesticideForm' className="justify-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
