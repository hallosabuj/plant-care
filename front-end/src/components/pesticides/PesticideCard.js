    ...
    return (
      <div>
        <div className='pr-1 pl-1 pt-3 pb-3 hover:scale-105 transition-all duration-300'>
          <div className='lg:h-[420px] md:h-[420px] h-[300px] shadow-md shadow-slate-600 rounded-lg'>
            <div className='lg:h-[320px] md:h-[320px] h-[200px] flex justify-center items-center bg-slate-500 bg-opacity-40 rounded-t-lg relative overflow-hidden p-3' >
