  ...
  render() {
    ...
    return !(this.state.fertilizerDetails)?(<div>Details not found</div>):(
      <div className='grid gap-2 p-2 w-full'>
          {/* Row 1 */}
          <div className='bg-white bg-opacity-20 flex justify-center items-center text-2xl md:text-4xl relative'>
          ...
          <div className='overflow-scroll scrollbar-hide'>
            <table className="w-full">
              <thead className="bg-white bg-opacity-50 text-xs text-gray-700 uppercase">
                <tr>
                  <th colSpan={3}>
                ...
                {this.state.plantLists && this.state.plantLists.map((plant, index) => {
                  return (
                    <tr key={index} className="bg-white bg-opacity-30 border-b">
                      ...
                      <th scope="row" className="py-4 px-6 font-medium text-gray-900 text-center text-nowrap">
                        {plant.plantName}
                      </th>
