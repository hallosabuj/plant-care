      ...
      <div>
        <div className='pr-1 pl-1 pt-3 pb-3 hover:scale-105 transition-all duration-300'>
          <div className='lg:h-[420px] md:h-[420px] h-[300px] rounded-lg shadow-lg '>
            <div className='lg:h-[320px] md:h-[320px] h-[200px] flex justify-center items-center rounded-t-lg relative overflow-hidden bg-slate-500 border-x-2 border-t-2 border-slate-900 p-3' >
            ...
            <div className=' h-[100px] rounded-b-lg flex justify-center items-center border-x-2 border-b-2 bg-slate-500 border-slate-900'>
