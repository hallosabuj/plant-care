  ...
  render() {
    return (
      <div>
        ...
        <div className=' h-auto w-full pl-16 bg-slate-200 flex items-center justify-center'>
          <div className='h-full w-1/2 mb-4 mt-4 hover:scale-105 transition-all duration-300 rounded-[3%] shadow-gray-600 shadow-md overflow-hidden'>
            <img src={caring} />
          </div>
          <div className='h-full w-1/2 p-6 ml-4 italic text-lg'>
        ...
        <div className='h-auto w-full bg-slate-200 pl-16 pr-16 pt-3 pb-8'>
