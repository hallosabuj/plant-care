...
class PlantCard extends Component {
  ...
  openPlantDetails=()=>{
    ...
    window.location.pathname="/plants/"+this.state.plant.plantId
  }
  render() {
  let imageUrl = "http://localhost:8080/plant/downloadImage/" + this.state.plant.profileImage
    return (
      <div className='pr-1 pl-1 pt-3 pb-3 shadow-lg lg:w-1/6 md:w-1/3 hover:scale-105'>
        <Card sx={{ border: 1, borderRadius: 2, height: "500px", backgroundColor: "cyan" }}>
          <div className='h-[300px] bg-lime-900 flex justify-center items-center p-2 rounded-md' onClick={this.openPlantDetails}>
